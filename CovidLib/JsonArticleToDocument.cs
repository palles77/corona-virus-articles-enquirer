...
namespace CovidLib
{
    public class JsonArticleToDocument
    {
        ...
        public static string GetArticleTitle(String articleContent)
        {
            var title = "";
        ...
        public static String GetArticleAbstract(String articleContent)
        {
            ...
            return articleAbstractBuilder.ToString();
        }
