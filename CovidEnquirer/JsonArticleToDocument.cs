...
{
    internal class JsonArticleToDocument
    {
        ...
        public static Article GetArticle(string articleFileName)
        {
            Article result = new Article() { FileName = articleFileName };
            var title = "";
            ...
            try
            {
                string articleContent = File.ReadAllText(articleFileName);
            ...
            result.Title = title;
            result.Abstract = articleAbstractBuilder.ToString();
